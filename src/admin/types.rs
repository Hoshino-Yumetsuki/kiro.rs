...
pub struct UpdateCompressionConfigRequest {
    ...
    pub tool_definition_compression: Option<bool>,
    pub tool_definition_size_threshold: Option<usize>,
    pub tool_definition_min_description_chars: Option<usize>,
    pub tool_name_max_chars: Option<usize>,
    ...
    pub adaptive_tool_result_compression: Option<bool>,
    pub adaptive_min_tool_result_max_chars: Option<usize>,
    pub adaptive_tool_use_input_compression: Option<bool>,
    pub adaptive_min_tool_use_input_max_chars: Option<usize>,
    pub adaptive_message_content_compression: Option<bool>,
    pub adaptive_min_message_content_max_chars: Option<usize>,
    pub adaptive_history_image_removal: Option<bool>,
    pub adaptive_history_removal: Option<bool>,
    pub adaptive_history_preserve_messages: Option<usize>,
}
