      ...
      <DialogContent className="sm:max-w-md">
        ...
        {balance &&
          (() => {
            ...
            const canOperateOverage =
              isPaidTier(balance.subscriptionTitle) &&
              balance.overageEnabled !== null &&
              balance.overageEnabled !== undefined;
                  ...
                  <div className="rounded-lg border bg-muted/40 p-3 space-y-3">
                    ...
                    {isOverspent && !balance.overageEnabled && (
                      <div className="text-xs text-destructive">
                        当前已用完基础 credits；开启失败通常表示 upstream 未授权该 profile 使用
                        overage。
                      </div>
                    )}
                  </div>
